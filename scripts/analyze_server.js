...
${server}:
    ...
    hack time  : ${ns.tFormat(ns.getHackTime(server))} (${ns.getHackTime(server)})
    grow time  : ${ns.tFormat(ns.getGrowTime(server))} (${ns.getGrowTime(server)})
    weaken time: ${ns.tFormat(ns.getWeakenTime(server))} (${ns.getWeakenTime(server)})
